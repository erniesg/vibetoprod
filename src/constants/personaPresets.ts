export const personaPresets = {
  'Vibe Coder': [
    { 
      ...
      priorities: ["Cost Optimization", "Global Performance", "Enterprise Security"]
    },
    { 
      ...
      priorities: ["Enterprise Security", "Global Performance", "Speed to Market"]
    },
    { 
      ...
      priorities: ["Speed to Market", "Cost Optimization"]
    }
  ],
  'AIE/FDE': [
    { 
      ...
      scale: "Growth" as const,
      priorities: ["Speed to Market", "Global Performance", "Enterprise Security"]
    },
    { 
      ...
      scale: "Enterprise" as const,
      priorities: ["Enterprise Security", "Global Performance", "Cost Optimization"]
    },
    { 
      label: "Headless CMS", 
      ...
      scale: "Growth" as const,
      priorities: ["Global Performance", "Speed to Market"]
    }
  ],
  'CIO/CTO': [
    { 
      ...
      scale: "Enterprise" as const,
      priorities: ["Global Performance", "Enterprise Security", "Cost Optimization"]
    },
    { 
      label: "IoT Platform", 
      ...
      scale: "Enterprise" as const,
      priorities: ["Speed to Market", "Enterprise Security", "Cost Optimization"]
    },
    { 
      ...
      priorities: ["Enterprise Security", "Cost Optimization", "Global Performance"]
    }
  ]
};
